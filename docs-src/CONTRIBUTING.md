...
First off, thank you for your interest in catch-app! We're excited
you're here.
...
catch-app follows a specific, AI-assisted workflow:
...
[Code of Conduct](https://github.com/efischer19/catch-app/blob/main/CODE_OF_CONDUCT.md).
