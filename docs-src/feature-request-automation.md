...
./scripts/create-feature-issues.sh --dry-run --category ui
...
./scripts/create-feature-issues.sh --category ui

# Create only high-priority issues in a category
./scripts/create-feature-issues.sh --category ui --priority high
```
...
| `--category CATEGORY` | Filter by feature category | `--category ui` |
